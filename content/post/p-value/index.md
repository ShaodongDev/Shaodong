...
<center>
    <img style="width: 50%; border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
...
<center>
    <img style="width: 40%; border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="./figure_1.png"">
    <br>
...
<center>
    ...
    <br>
    <div style="color:orange;color: #999; padding: 0px;">A样本平均咸度 = 8.324234232</div>
</center>
